...
from m6.bruteforce.shgoportfolio import upside_maximizing_portfolio_shgo
...
if __name__=='__main__':
    ...
    port, metrics = upside_maximizing_portfolio_shgo(daily_generator=example_daily_generator_5, return_type='log', **kwargs)
